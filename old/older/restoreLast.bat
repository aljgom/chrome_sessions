...
copy "%CD%\Last Session" "%HOMEPATH%\AppData\Local\Google\Chrome\User Data\Default\Current Session" 

copy "%CD%\Last Tabs" "%HOMEPATH%\AppData\Local\Google\Chrome\User Data\Default\Current Tabs"
